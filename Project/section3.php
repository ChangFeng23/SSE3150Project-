...
<form method="POST">
 <div id=containerFea class="container-fluid">
        ...
        $stmt = $pdo->query("SELECT sum(value) as total From score WHERE section = 3");
        ...
        if($_SESSION['b']=='1'){
            echo('<div class="col-lg-6 col-md-6 col-sm-12"style="background-color:lavender;">');
            echo "if the project has no procurement (addressed in question 2) the minimum score is automatically assigned for each question in the procurement section.";
            echo '</div>';
        }
        ?>
                </div>
